...
const Ticket = ({ bookingReference }) => {
  ...
  return (
    <div className="container col-md-10 bg-white p-5">
      <div className="row">
        <div className="card">
          <div className="card-body">
            <h4 className="card-title">Ticket No: <span id="ticketNumber">{ticketData.ticketNumber}</span></h4>
            <p className="card-text"><h5><i>AAA Airlines</i>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Date issued:</h5><span id="dateIssued">{ticketData.dateIssued}</span></p>
            <br />
            <p className="card-text"><h6>Passenger:</h6><span id="passengerName">{ticketData.passengerName}</span></p>
            <hr className="darker-hr" />
